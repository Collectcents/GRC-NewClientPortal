...
s.trackingServer = "navientinc.d1.sc.omtrdc.net"
s.visitorNamespace = "navientinc"


/* STANDARD SITE WIDE TRACKING  */
...
/* Add calls to plugins here */
	...
	if(!s.campaign)
		s.campaign=s.getQueryParam('dtd_cell');
...
if(!s.year){
	...
	s.eVar35=s.getTimeParting('h','-5',s.year); // Set hour 
	s.eVar34=s.getTimeParting('d','-5',s.year); // Set day	
}
